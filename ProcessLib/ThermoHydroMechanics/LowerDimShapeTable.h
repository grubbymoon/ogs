...
#ifndef PROCESS_LIB_THERMOHYDROMECHANICS_LOWERSHAPETABLE_H_
#define PROCESS_LIB_THERMOHYDROMECHANICS_LOWERSHAPETABLE_H_
...
#endif  // PROCESS_LIB_THERMOHYDROMECHANICS_LOWERSHAPETABLE_H_
