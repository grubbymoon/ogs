...
namespace
{
std::size_t count_mesh_items(MeshLib::Mesh const& mesh,
...
ProcessOutput::ProcessOutput(BaseLib::ConfigTree const& output_config)
{
    ...
    if (auto out_resid =
        ...
        output_config.getConfigParameterOptional<bool>(
...
// Copy result
         ...
         ++variable_id)
    {
        ...
        for (int component_id = 0; component_id < num_comp; ++component_id)
        {
            auto const& mesh_subsets =
                dof_table.getMeshSubsets(variable_id, component_id);
    ...
    auto add_secondary_var = [&](SecondaryVariable const& var,
...

        {
            ...
            auto* const result = getOrCreateMeshProperty(
