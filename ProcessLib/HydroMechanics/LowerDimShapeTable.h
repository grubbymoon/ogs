...
#ifndef PROCESS_LIB_HYDROMECHANICS_LOWERSHAPETABLE_H_
#define PROCESS_LIB_HYDROMECHANICS_LOWERSHAPETABLE_H_
...
#endif  // PROCESS_LIB_HYDROMECHANICS_LOWERSHAPETABLE_H_
