...
const double TestLine3::nat_exp_N[e_nnodes] = {0.25, 0.75};
const double TestLine3::nat_exp_dNdr[e_nnodes * dim] = {-0.5, 0.5};
...
const double TestLine3::ir_exp_dNdx[dim * e_nnodes] = {-0.25, 0.25};
